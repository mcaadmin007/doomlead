    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-[360px] text-center">
          <div className="mb-8">
            <h1 className="text-[26px] font-bold tracking-tight mb-2">เข้าสู่ระบบ</h1>
            <p className="text-sm text-zinc-500">ใช้ Gmail เพื่อเข้าสู่ระบบ DoomLead</p>
          </div>
          ...
          <p className="text-xs text-zinc-400 mt-6">
            สมัครและ Login ใช้ปุ่มเดียวกัน — กด Login ด้วย Google ได้เลย
          </p>
        </div>
      </div>
    </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center text-sm text-zinc-400">กำลังโหลด...</div>}>
      <LoginForm />
    </Suspense>
  )
}
